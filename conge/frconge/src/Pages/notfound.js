...
// Définir la fonction drawVisor en dehors du composant
const drawVisor = () => {
...
// Définir la fonction animateCord en dehors du composant
const animateCord = () => {
    ...
    const animate = () => {
        ...
        ctx.clearRect(0, 0, window.innerWidth, window.innerHeight);  // Utilisation de window.innerWidth et window.innerHeight
